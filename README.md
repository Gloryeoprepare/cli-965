...
[Aliyun Model Studio CLI Site](https://bailian.console.aliyun.com/cli?source_channel=cli_github&) · [中文文档](https://github.com/Gloryeoprepare/cli-965/blob/main/README_CN.md) · [API Documentation](https://help.aliyun.com/zh/model-studio/) · [Get API Key](https://bailian.console.aliyun.com/cli?source_channel=key_github&)
...
```bash
git clone https://github.com/Gloryeoprepare/cli-965.git
cd cli-965
python setup.py
```
...
Bug reports, feature requests, and PRs are welcome. See [CONTRIBUTING.md](https://github.com/Gloryeoprepare/cli-965/blob/main/CONTRIBUTING.md) for developer setup, repo layout, and the workflow for adding or changing commands.


<!-- Last updated: 2026-06-06 16:06:03 -->
